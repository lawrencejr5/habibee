                    ...
                    {subHabits.map((item, index) => (
                      ...
                      >
                        {editingId === item._id ? (
                          ...
                          // ── View mode ───────────────────────────────────────
                          (() => {
                            const isCompleted = habit?.archived
                              ? true
                              : item.completed;
                            return (
                              <>
                                ...
                                >
                                  <Pressable
                                    ...
                                    disabled={
                                      togglingId === item._id || isParentDone
                                    }
                                  >
                                    <View
                                      style={{
                                ...
                                >
                                  <View style={{ position: "relative" }}>
                                    <Pressable
                                      ...
                                      disabled={
                                        updatingId === item._id || isParentDone
                                      }
                                      style={{
                                        flexDirection: "row",
                                        alignItems: "center",
