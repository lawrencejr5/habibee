      ...
      <main className={styles.container}>
        ...
        <div className={styles.content}>
          <p>
            ...
            regulations for the use of Lawjun Labs's Habibee Mobile Application and
            Website.
          </p>
          <p>
            By accessing this app, we assume you accept these terms and conditions. Do
            not continue to use Habibee if you do not agree to take all of the terms
          ...
          <p>
            ...
            intellectual property rights for all material on Habibee. All intellectual
            property rights are reserved. You may access this from Habibee for your
          ...
          <p>
            The app's mechanics, including "streaks" and "hives", are intended for
            personal motivation and accountability. Lawjun Labs is not responsible for
            any loss of streak data due to device malfunction, network issues, or
            system updates, though we will make reasonable efforts to ensure data
            integrity.
          </p>
          ...
          <p>
            Lawjun Labs reserves the right to monitor all Comments and to remove any
          ...
          <p>
            Habibee utilizes Artificial Intelligence to provide coaching and insights.
            These insights are generated algorithmically and are for motivational and
            organizational purposes only. They do not constitute professional medical,
          ...
          <p>
            ...
            of this app. Nothing in this disclaimer will:
          </p>
          <ul>
          ...
          <p>
            <strong>Lawjun Labs</strong><br />
            Email: <a href="mailto:terms@lawjunlabs.com">terms@lawjunlabs.com</a>
          </p>
        </div>
      </main>
