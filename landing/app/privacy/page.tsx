      ...
      <main className={styles.container}>
        ...
        <div className={styles.content}>
          <p>
            ...
            when you visit our Habibee mobile application and website. Please read
          ...
          <ul>
            <li>
              ...
              such as your name, email address, and profile picture, that you
            ...
            <li>
              ...
              native actions that are integral to the Application, including tracking
              habits, streaks, and interactions with Hives.
            </li>
            <li>
              ...
              location of your device, if you access the Application from a mobile
              device.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>Power the Habibee AI coaching features to provide personalized recommendations.</li>
            <li>Monitor and analyze usage and trends to improve your experience with the Application.</li>
            <li>Notify you of updates to the Application.</li>
            <li>Send you reminders for your habits if you have enabled notifications.</li>
          </ul>
          ...
          <ul>
            <li>
              ...
              process, to investigate or remedy potential violations of our policies,
            ...
            <li>
              ...
              behalf, including data analysis, email delivery, hosting services, and
              customer service.
            </li>
            <li>
              <strong>Interactions with Other Users:</strong> If you interact with
              other users of the Application (such as in a "Hive"), those users may
          ...
          <p>
            ...
            Email: <a href="mailto:support@lawjunlabs.com">support@lawjunlabs.com</a>
          </p>
        </div>
      </main>
